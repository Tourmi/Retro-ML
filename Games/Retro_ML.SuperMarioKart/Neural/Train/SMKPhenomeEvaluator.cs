...
namespace Retro_ML.SuperMarioKart.Neural.Train
{
    ...
    /// </summary>
    internal class SMKPhenomeEvaluator : IPhenomeEvaluator<IBlackBox<double>>
    {
        ...
        public SMKPhenomeEvaluator(EmulatorManager emulatorManager, ApplicationConfig appConfig, SMKTrainer trainer)
        {
        ...
        public FitnessInfo Evaluate(IBlackBox<double> phenome)
        {
            try
            {
                ...
                dataFetcher = (SMKDataFetcher)emulator.GetDataFetcher();

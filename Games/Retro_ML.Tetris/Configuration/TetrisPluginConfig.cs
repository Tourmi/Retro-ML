...
internal class TetrisPluginConfig : IGamePluginConfig
{
    ...
    public void InitNeuralConfig(NeuralConfig neuralConfig)
    {
        ...
        neuralConfig.InputNodes.Add(new InputNode("Current Block Rotation", neuralConfig.EnabledStates[enabledIndex++], (dataFetcher) => ((TetrisDataFetcher)dataFetcher).GetCurrentBlockRotation(), 4, 1));

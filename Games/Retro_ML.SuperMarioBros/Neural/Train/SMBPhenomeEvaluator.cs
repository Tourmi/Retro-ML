...
namespace Retro_ML.SuperMarioBros.Neural.Train
{
    ...
    /// </summary>
    internal class SMBPhenomeEvaluator : IPhenomeEvaluator<IBlackBox<double>>
    {
        ...
        public SMBPhenomeEvaluator(EmulatorManager emulatorManager, ApplicationConfig appConfig, SMBTrainer trainer)
        {
        ...
        public FitnessInfo Evaluate(IBlackBox<double> phenome)
        {
            try
            {
                ...
                dataFetcher = (SMBDataFetcher)emulator.GetDataFetcher();
